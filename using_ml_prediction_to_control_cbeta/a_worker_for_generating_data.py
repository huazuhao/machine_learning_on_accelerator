#####4/10/19## updated to remove decision variables with zero range from being a feature
...
def main(input_index,cwd):
    ...
    for j in range(Nsamples):
        ...
        try:
            ...
            #I open the pickle file to get the data
    ...
    print('we are in a worker for generating data and the y dictionary looks like')
    print(YDic)
